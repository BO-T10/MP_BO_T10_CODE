...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=1,
            help="number of images used in trades" "including the current image",
        )
        ...
        self.parser.add_argument(
            "--trades",
            action="store_true",
            help="Track to Detect and Segment:" "An Online Multi Object Tracker",
        )
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        if opt.seg:
            opt.heads.update(
                {
                    "conv_weight": 2 * opt.seg_feat_channel ** 2
                    + 5 * opt.seg_feat_channel
                    + 1
                }
            )
