...
def custom_image_editor(
    inp_img, idx, xmin, ymin, xmax, ymax, age_actual, gender, age_low, age_high
):
    ...
    cv2.putText(
        im,
        f"{gender} | {age_actual} | [{age_low},{age_high}]",
        (xmin, ymax),
...
def run_predictions_video():
    ...
    while success:
        ...
        for i in range(len(df_temp)):
            ...
            modified_image = custom_image_editor(
                modified_image,
                df_temp.iloc[i, 1],
                xmin,
                ymin,
